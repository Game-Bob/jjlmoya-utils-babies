...
const UTILITY_ASSET_ROOT = "/_utilities/babies";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/babies/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/babies/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("babies");
